...
namespace D3TypeDump
{
    class TypeDump
    {
        ...
        const int AttributesAddress = 0x01A04400;//0x016E4BF8;//0x0168D778;
        const int AttributeCount = 1371;//895;//878;
        //const int Attribute_Int = 0x01373660;
        //const int Attribute_Int = 0x014c3ce4;
        const int Attribute_Int = 0x017bdc4c;

        //const int Attribute_IntMinMax = 0x01373668;
        //const int Attribute_IntMinMax = 0x014c3cf0;
        //const int Attribute_IntMinMax = 0x01514a00;
        const int Attribute_IntMinMax = 0x017bdc58;
        const int Attribute_FloatMinMax = 0x01373670;
        //const int Attribute_Float16 = 0x01373678;
        //const int Attribute_Float16 = 0x014c3d08;
        //const int Attribute_Float16 = 0x01514a18;
        const int Attribute_Float16 = 0x017bdc70;
        //const int Attribute_Float16Or32 = 0x01373680;
        //const int Attribute_Float16Or32 = 0x01514a24;
        const int Attribute_Float16Or32 = 0x017bdc7c;

        //const int Attribute_Float16Or32 = 0x015149f4;
        #endregion
